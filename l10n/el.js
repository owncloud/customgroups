OC.L10N.register(
    ...
    "There are currently no user defined groups" : "Δεν υπάρχουν προς στιγμήν προσαρμοσμένες ομάδες χρηστών",
    "Add user to this group" : "Προσθήκη χρήστη στην ομάδα",
    ...
    "Could not leave group due to a server error" : "Αδυναμία αποχώρησης απο την ομάδα  λόγω σφάλματος διακομιστή",
    ...
    "You have been added to the group \"%2$s\" by \"%1$s\"." : "Προστεθήκατε στην ομάδα \"%2$s\" από τον/την \"%1$s\".",
    "Removed from group \"%2$s\"." : "Απέλαση από την ομάδα \"%2$s\".",
    "You have been removed from the group \"%2$s\" by \"%1$s\"." : "Ο/Η \"%1$s\" σας έβγαλε από την ομάδα \"%2$s\".",
    "Role change in group \"%1$s\"." : "Αλλαγή ρόλου στην ομάδα \"%1$s\".",
    "\"%1$s\" assigned the \"%3$s\" role for the group \"%2$s\" to you." : "Ο/Η \"%1$s\" σας ανέθεσε το ρόλο \"%3$s\" στην ομάδα \"%2$s\".",
