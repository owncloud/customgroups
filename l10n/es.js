OC.L10N.register(
    ...
    "Guest" : "Invitado",
    "User" : "Usuario",
    "Could not add the following users: {users}" : "No se pudieron añadir los siguientes usuarios: {users}",
    ...
    "Cannot change role without another administrator" : "No se puede cambiar el rol sin otro administrador",
    "Could not change role" : "No se pudo cambiar el rol",
    "Are you sure that you want to change your own permissions for the group \"{name}\" ?" : "¿Está seguro que desea cambiar sus propios permisos del grupo \"(name)\"?",
    "Confirm role change" : "Confirmar cambio de rol",
    "Member (Guest)" : "Miembro (invitado)",
